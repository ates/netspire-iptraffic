...
decode_col({_Name, _Format, _ColNumber, Oid, _Size, _Modifier, _TableOID}, Value) when Oid == float8 ->
    <<N:1/big-float-unit:64>> = Value, N;
decode_col({_Name, _Format, _ColNumber, Oid, _Size, _Modifier, _TableOID}, Value) when Oid == inet ->
    <<_Rest:32, I1:8, I2:8, I3:8, I4:8>> = Value,
    {I1, I2, I3, I4};
